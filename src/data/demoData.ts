...
export const INITIAL_PLACES: Place[] = [
  {
    id:'koffee-mame', name:'Koffee Mame', area:'Omotesando', kind:'Café', mentions:2, selected:true, decision:'kept',
  ...
  {
    id:'sensoji', name:'Senso-ji Temple', area:'Asakusa', kind:'Attraction', mentions:3, selected:true, decision:'kept',
  ...
  {
    id:'ueno', name:'Ueno Park', area:'Ueno', kind:'Park', mentions:2, selected:true, decision:'kept',
  ...
  {
    id:'restaurant-a', name:'Restaurant A', area:'Shibuya', kind:'Dinner', mentions:2, selected:true, decision:'review',
  ...
  {
    id:'daikanyama', name:'Daikanyama Café', area:'Daikanyama', kind:'Café', mentions:1, selected:false, decision:'candidate',
  ...
  {
    id:'shibuya', name:'Shibuya Crossing', area:'Shibuya', kind:'Walk', mentions:4, selected:true, decision:'kept',
...
export const EXTRACTED_BATCH: Place[] = [
  {
    id:'meiji', name:'Meiji Jingu', area:'Harajuku', kind:'Attraction', mentions:2, selected:false, decision:'candidate',
  ...
  {
    id:'teamlab', name:'teamLab Borderless', area:'Azabudai', kind:'Museum', mentions:1, selected:false, decision:'candidate',
    status:'unverified', postAge:'just added', confidence:'Medium',
